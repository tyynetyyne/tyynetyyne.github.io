...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname tikkataulu_esimerkkitarkaisuja) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(require 2htdp/image)
