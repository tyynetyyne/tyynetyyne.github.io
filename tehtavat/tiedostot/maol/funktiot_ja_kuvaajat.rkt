...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname funktiot_ja_kuvaajat) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
