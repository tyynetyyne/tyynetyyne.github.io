...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname geometrinen_kuvio_A_esimerkkiratkaisuja) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
