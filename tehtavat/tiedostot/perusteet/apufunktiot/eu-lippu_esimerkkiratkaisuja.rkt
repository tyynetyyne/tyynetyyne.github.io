...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname eu-lippu_esimerkkiratkaisuja) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
